...
我们先从一个聊天软件说起，我们要实现A能发一个hello消息给B：

![图片](./images/一文搞明白HTTPS工作原理,图文并茂/1.jpg)
...
![图片](./images/一文搞明白HTTPS工作原理,图文并茂/2.jpg)
...
![图片](./images/一文搞明白HTTPS工作原理,图文并茂/5.jpg)
...
![图片](./images/一文搞明白HTTPS工作原理,图文并茂/6.jpg)
...
![图片](./images/一文搞明白HTTPS工作原理,图文并茂/7.jpg)
...
![图片](./images/一文搞明白HTTPS工作原理,图文并茂/8.jpg)

如果能解密，就说明这个公钥没有被中间人调包。因为如果中间人使用自己的私钥加密后的东西传给客户端，客户端是无法使用第三方的公钥进行解密的。

![图片](./images/一文搞明白HTTPS工作原理,图文并茂/9.jpg)
...
![图片](./images/一文搞明白HTTPS工作原理,图文并茂/10.jpg)

客户端能解密同一家第三机构颁发的所有证书：

![图片](./images/一文搞明白HTTPS工作原理,图文并茂/11.jpg)

最终导致其它持有同一家第三方机构证书的中间人可以进行调包：

![图片](./images/一文搞明白HTTPS工作原理,图文并茂/12.jpg)
...
![图片](./images/一文搞明白HTTPS工作原理,图文并茂/13.jpg)
...
![图片](./images/一文搞明白HTTPS工作原理,图文并茂/14.jpg)

当客户端拿到证书后，开始对证书中的内容进行验证，如果客户端计算出来的证书编号与证书中的证书编号相同，则验证通过：

![图片](./images/一文搞明白HTTPS工作原理,图文并茂/15.jpg)
...
![图片](./images/一文搞明白HTTPS工作原理,图文并茂/16.jpg)
...
![图片](./images/一文搞明白HTTPS工作原理,图文并茂/17.jpg)
