...
go env -w GOPRIVATE=gitlab.ttpark.cn
go env -w GOINSECURE=gitlab.ttpark.cn
```
...
![VscodeGo工具下载](./images/VscodeGo工具下载.png)
...
go get -insecure gitlab.ttpark.cn/Device/Tool
```
