...
先来看一下 nil channel 的情况，也就是向没有 make 的 channel 发送数据。上篇文章 [深入理解 Go Channel](http://legendtkl.com/2017/07/30/understanding-golang-channel/) 中留了一个问题：向 nil channel 发送数据会报 ***fatal error: all goroutines are asleep - deadlock!\*** 错误。
