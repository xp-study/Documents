...
![img](./images/深度解密Go语言之context/1.jpg)
...
![img](./images/深度解密Go语言之context/2.jpg)
...
![img](./images/深度解密Go语言之context/3.jpg)

![img](./images/深度解密Go语言之context/4.jpg)

上面这张表展示了 context 的所有函数、接口、结构体，可以纵览全局，可以在读完文章后，再回头细看。

整体类图如下：

![img](./images/深度解密Go语言之context/5.jpg)
...
![img](./images/深度解密Go语言之context/6.jpg)
...
![img](./images/深度解密Go语言之context/7.jpg)
