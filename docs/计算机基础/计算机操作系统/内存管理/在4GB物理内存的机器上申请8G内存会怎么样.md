...
![img](https://mc.wsh-study.com/mkdocs/在4GB物理内存的机器上申请8G内存会怎么样/1.png)
...
![img](https://mc.wsh-study.com/mkdocs/在4GB物理内存的机器上申请8G内存会怎么样/2.png)
...
![img](https://mc.wsh-study.com/mkdocs/在4GB物理内存的机器上申请8G内存会怎么样/3.png)
...
![img](https://mc.wsh-study.com/mkdocs/在4GB物理内存的机器上申请8G内存会怎么样/4.png)
...
![img](https://mc.wsh-study.com/mkdocs/在4GB物理内存的机器上申请8G内存会怎么样/5.png)
...
![img](https://mc.wsh-study.com/mkdocs/在4GB物理内存的机器上申请8G内存会怎么样/6.png)
...
![img](https://mc.wsh-study.com/mkdocs/在4GB物理内存的机器上申请8G内存会怎么样/7.png)
...
![img](https://mc.wsh-study.com/mkdocs/在4GB物理内存的机器上申请8G内存会怎么样/8.png)
...
![img](https://mc.wsh-study.com/mkdocs/在4GB物理内存的机器上申请8G内存会怎么样/9.png)
...
![img](https://mc.wsh-study.com/mkdocs/在4GB物理内存的机器上申请8G内存会怎么样/10.png)

此时我的笔记本电脑的磁盘开始出现“沙沙”的声音，通过查看磁盘的 I/O 情况，可以看到磁盘 I/O 达到了一个峰值，非常高：

![img](https://mc.wsh-study.com/mkdocs/在4GB物理内存的机器上申请8G内存会怎么样/11.png)
...
![img](https://mc.wsh-study.com/mkdocs/在4GB物理内存的机器上申请8G内存会怎么样/12.png)
