...
![图片](https://mc.wsh-study.com/mkdocs/malloc是如何分配内存的/1.png)
...
![图片](https://mc.wsh-study.com/mkdocs/malloc是如何分配内存的/2.png)
...
![图片](https://mc.wsh-study.com/mkdocs/malloc是如何分配内存的/3.png)
...
![img](https://mc.wsh-study.com/mkdocs/malloc是如何分配内存的/4.png)

方式二通过 mmap() 系统调用中「私有匿名映射」的方式，在文件映射区分配一块内存，也就是从文件映射区“偷”了一块内存。如下图：

![img](https://mc.wsh-study.com/mkdocs/malloc是如何分配内存的/5.png)
...
![图片](https://mc.wsh-study.com/mkdocs/malloc是如何分配内存的/6.png)
...
![图片](https://mc.wsh-study.com/mkdocs/malloc是如何分配内存的/7.png)

从下图可以看到，通过 free 释放内存后，堆内存还是存在的，并没有归还给操作系统。

![图片](https://mc.wsh-study.com/mkdocs/malloc是如何分配内存的/8.png)
...
![图片](https://mc.wsh-study.com/mkdocs/malloc是如何分配内存的/9.png)

查看进程的内存的分布情况，可以发现最右边没有 [head] 标志，说明是通过 mmap 以匿名映射的方式从文件映射区分配的匿名内存。

![图片](https://mc.wsh-study.com/mkdocs/malloc是如何分配内存的/10.png)

然后我们释放掉这个内存看看：

![图片](https://mc.wsh-study.com/mkdocs/malloc是如何分配内存的/11.png)

再次查看该 128 KB 内存的起始地址，可以发现已经不存在了，说明归还给了操作系统。

![图片](https://mc.wsh-study.com/mkdocs/malloc是如何分配内存的/12.png)
...
![图片](https://mc.wsh-study.com/mkdocs/malloc是如何分配内存的/13.png)
...
![图片](https://mc.wsh-study.com/mkdocs/malloc是如何分配内存的/14.png)
