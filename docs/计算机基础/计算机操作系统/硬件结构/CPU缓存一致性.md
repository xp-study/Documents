...
![img](https://mc.wsh-study.com/mkdocs/CPU缓存一致性/1.png)
...
![img](https://mc.wsh-study.com/mkdocs/CPU缓存一致性/2.png)
...
![img](https://mc.wsh-study.com/mkdocs/CPU缓存一致性/3.png)
...
![img](https://mc.wsh-study.com/mkdocs/CPU缓存一致性/4.png)
...
![img](https://mc.wsh-study.com/mkdocs/CPU缓存一致性/5.png)
...
![img](https://mc.wsh-study.com/mkdocs/CPU缓存一致性/6.png)
...
![img](https://mc.wsh-study.com/mkdocs/CPU缓存一致性/7.png)
...
![img](https://mc.wsh-study.com/mkdocs/CPU缓存一致性/8.png)
...
![img](https://mc.wsh-study.com/mkdocs/CPU缓存一致性/9.png)

MESI 协议的四种状态之间的流转过程，我汇总成了下面的表格，你可以更详细的看到每个状态转换的原因：

![img](https://mc.wsh-study.com/mkdocs/CPU缓存一致性/10.png)
