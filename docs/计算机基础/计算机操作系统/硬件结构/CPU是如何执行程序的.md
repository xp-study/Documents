...
![img](https://mc.wsh-study.com/mkdocs/CPU是如何执行程序的/1.png)
...
![](https://mc.wsh-study.com/mkdocs/CPU是如何执行程序的/2.png)
...
![img](https://mc.wsh-study.com/mkdocs/CPU是如何执行程序的/3.png)

- 接着，读写头读入 1 到存储设备中，这个存储设备称为图灵机的状态；

![img](https://mc.wsh-study.com/mkdocs/CPU是如何执行程序的/4.png)

- 然后读写头向右移动一个格，用同样的方式把 2 读入到图灵机的状态，于是现在图灵机的状态中存储着两个连续的数字， 1 和 2；

![img](https://mc.wsh-study.com/mkdocs/CPU是如何执行程序的/5.png)
...
![img](https://mc.wsh-study.com/mkdocs/CPU是如何执行程序的/6.png)

- 最后，运算单元将结果返回给控制单元，控制单元将结果传输给读写头，读写头向右移动，把结果 3 写入到纸带的格子中；

![img](https://mc.wsh-study.com/mkdocs/CPU是如何执行程序的/7.png)
...
![img](https://mc.wsh-study.com/mkdocs/CPU是如何执行程序的/8.png)

运算器、控制器是在中央处理器里的，存储器就我们常见的内存，输入输出设备则是计算机外接的设备，比如键盘就是输入设备，显示器就是输出设备。

存储单元和输入输出设备要与中央处理器打交道的话，离不开总线。所以，它们之间的关系如下图：

![img](https://mc.wsh-study.com/mkdocs/CPU是如何执行程序的/9.png)
...
![img](https://mc.wsh-study.com/mkdocs/CPU是如何执行程序的/10.png)
...
![img](https://mc.wsh-study.com/mkdocs/CPU是如何执行程序的/11.png)
...
![img](https://mc.wsh-study.com/mkdocs/CPU是如何执行程序的/12.png)
...
![img](https://mc.wsh-study.com/mkdocs/CPU是如何执行程序的/13.png)
...
![img](https://mc.wsh-study.com/mkdocs/CPU是如何执行程序的/14.png)
...
![img](https://mc.wsh-study.com/mkdocs/CPU是如何执行程序的/15.png)
...
![img](https://mc.wsh-study.com/mkdocs/CPU是如何执行程序的/16.png)
...
![img](https://mc.wsh-study.com/mkdocs/CPU是如何执行程序的/17.png)
