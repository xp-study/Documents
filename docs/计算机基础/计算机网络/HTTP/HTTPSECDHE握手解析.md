...
![img](https://mc.wsh-study.com/mkdocs/HTTPSECDHE握手解析/1.png)
...
![img](https://mc.wsh-study.com/mkdocs/HTTPSECDHE握手解析/2.png)

那么对于底数为 2 的时候， 32 的对数是 5，64 的对数是 6，计算过程如下：

![img](https://mc.wsh-study.com/mkdocs/HTTPSECDHE握手解析/3.png)

对数运算的取值是可以连续的，而离散对数的取值是不能连续的，因此也以「离散」得名，

离散对数是在对数运算的基础上加了「模运算」，也就说取余数，对应编程语言的操作符是「%」，也可以用 mod 表示。离散对数的概念如下图：

![img](https://mc.wsh-study.com/mkdocs/HTTPSECDHE握手解析/4.png)
...
![img](https://mc.wsh-study.com/mkdocs/HTTPSECDHE握手解析/5.png)
...
![img](https://mc.wsh-study.com/mkdocs/HTTPSECDHE握手解析/6.png)
...
![img](https://mc.wsh-study.com/mkdocs/HTTPSECDHE握手解析/9.png)

这一步就和 RSA 握手过程有很大的区别了，因为服务端选择了 ECDHE 密钥协商算法，所以会在发送完证书后，发送「 **Server Key Exchange** 」消息。

![img](https://mc.wsh-study.com/mkdocs/HTTPSECDHE握手解析/10.png)
...
![img](https://mc.wsh-study.com/mkdocs/HTTPSECDHE握手解析/11.png)
...
![img](https://mc.wsh-study.com/mkdocs/HTTPSECDHE握手解析/12.png)
...
![img](https://mc.wsh-study.com/mkdocs/HTTPSECDHE握手解析/13.png)

接着，客户端会发「 **Encrypted Handshake Message** 」消息，把之前发送的数据做一个摘要，再用对称密钥加密一下，让服务端做个验证，验证下本次生成的对称密钥是否可以正常使用。

![img](https://mc.wsh-study.com/mkdocs/HTTPSECDHE握手解析/14.png)
