...
![提纲](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/1.png)
...
![三个部分](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/2.png)
...
![三方协议和租房协议](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/3.png)
...
![请求 - 应答](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/4.png)
...
![ 五大类 HTTP 状态码 ](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/5.png)
...
![img](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/6.png)
...
![img](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/7.png)
...
![img](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/8.png)

HTTP 长连接的特点是，只要任意一端没有明确提出断开连接，则保持 TCP 连接状态。

![HTTP 长连接](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/9.png)
...
![img](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/10.png)
...
![img](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/11.png)
...
![GET 请求](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/12.png)

根据 RFC 规范， **POST 的语义是根据请求负荷（报文body）对指定的资源做出处理** ，具体的处理方式视资源类型而不同。POST 请求携带数据的位置一般是写在报文 body 中， body 中的数据可以是任意格式的数据，只要客户端与服务端协商好即可，而且浏览器不会对 body 大小做限制。

比如，你在我文章底部，敲入了留言后点击「提交」（ **暗示你们留言** ），浏览器就会执行一次 POST 请求，把你的留言文字放进了报文 body 里，然后拼接好 POST 请求头，通过 TCP 协议发送给服务器。

![POST 请求](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/13.png)
...
![img](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/14.png)
...
![img](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/15.png)
...
![img](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/16.png)
...
![Cookie 技术](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/17.png)
...
![img](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/18.png)
...
![短连接与长连接](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/19.png)
...
![管道网络传输](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/20.png)
...
![队头阻塞](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/21.png)
...
![HTTP 与 HTTPS 网络层](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/22.png)
...
![混合加密](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/23.png)
...
![img](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/24.png)
...
![img](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/25.png)
...
![数子证书工作流程](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/26.png)
...
![HTTPS 连接建立过程](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/27.png)
...
![img](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/28.png)
...
![img](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/29.png)
...
![img](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/30.png)

操作系统里一般都会内置一些根证书，比如我的 MAC 电脑里内置的根证书有这么多：

![img](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/31.png)

这样的一层层地验证就构成了一条信任链路，整个证书信任链验证流程如下图所示：

![img](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/32.png)
...
![img](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/33.png)
...
![img](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/34.png)

这个问题的场景是这样的：客户端通过浏览器向服务端发起 HTTPS 请求时，被「假基站」转发到了一个「中间人服务器」，于是客户端是和「中间人服务器」完成了 TLS 握手，然后这个「中间人服务器」再与真正的服务端完成 TLS 握手。

![img](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/35.png)
...
![img](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/36.png)
...
![img](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/37.png)
...
![HTT/1 ~ HTTP/2](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/38.png)
...
![HTTP/1 与 HTTP/2 ](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/39.png)

这样虽然对人不友好，但是对计算机非常友好，因为计算机只懂二进制，那么收到报文后，无需再将明文的报文转成二进制，而是直接解析二进制报文，这 **增加了数据传输的效率** 。

比如状态码 200 ，在 HTTP/1.1 是用 '2''0''0' 三个字符来表示（二进制：00110010 00110000 00110000），共用了 3 个字节，如下图

![img](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/40.png)

在 HTTP/2 对于状态码 200 的二进制编码是 10001000，只用了 1 字节就能表示，相比于 HTTP/1.1 节省了 2 个字节，如下图：

![img](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/41.png)

Header: :status: 200 OK 的编码内容为：1000 1000，那么表达的含义是什么呢？

![img](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/42.png)
...
![img](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/43.png)
...
![img](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/44.png)
...
![img](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/47.png)

举个例子，如下图：

![img](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/48.png)
...
![HTTP/1 ~ HTTP/3](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/49.png)
...
![img](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/50.png)
...
![TCP HTTPS（TLS/1.3） 和 QUIC HTTPS ](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/51.png)

甚至，在第二次连接的时候，应用数据包可以和 QUIC 握手信息（连接信息 + TLS 信息）一起发送，达到 0-RTT 的效果。

如下图右边部分，HTTP/3 当会话恢复时，有效负载数据与第一个数据包一起发送，可以做到 0-RTT（下图的右下角）：

![img](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/52.png)

*3、连接迁移*

基于 TCP 传输协议的 HTTP 协议，由于是通过四元组（源 IP、源端口、目的 IP、目的端口）确定一条 TCP 连接。

![TCP 四元组](https://mc.wsh-study.com/mkdocs/HTTP常见面试题/53.png)
