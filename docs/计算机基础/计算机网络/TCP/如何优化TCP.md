...
![Linux TCP 参数](https://mc.wsh-study.com/mkdocs/如何优化TCP/1.jpg)
...
![本节提纲](https://mc.wsh-study.com/mkdocs/如何优化TCP/2.jpg)
...
![三次握手与数据传输](https://mc.wsh-study.com/mkdocs/如何优化TCP/3.jpg)
...
![TCP 三次握手的状态变迁](https://mc.wsh-study.com/mkdocs/如何优化TCP/4.jpg)
...
![TCP 头部](https://mc.wsh-study.com/mkdocs/如何优化TCP/5.jpg)
...
![img](https://mc.wsh-study.com/mkdocs/如何优化TCP/6.jpg)
...
![SYN 超时重传](https://mc.wsh-study.com/mkdocs/如何优化TCP/7.jpg)
...
![半连接队列与全连接队列](https://mc.wsh-study.com/mkdocs/如何优化TCP/8.jpg)
...
![img](https://mc.wsh-study.com/mkdocs/如何优化TCP/9.jpg)
...
![img](https://mc.wsh-study.com/mkdocs/如何优化TCP/10.jpg)

增大 backlog 的方式，每个 Web 服务都不同，比如 Nginx 增大 backlog 的方法如下：

![img](https://mc.wsh-study.com/mkdocs/如何优化TCP/11.jpg)
...
![开启 syncookies 功能](https://mc.wsh-study.com/mkdocs/如何优化TCP/12.jpg)
...
![img](https://mc.wsh-study.com/mkdocs/如何优化TCP/13.jpg)
...
![img](https://mc.wsh-study.com/mkdocs/如何优化TCP/14.jpg)
...
![ accept 队列溢出](https://mc.wsh-study.com/mkdocs/如何优化TCP/15.jpg)

> accept 队列已满，只能丢弃连接吗？

丢弃连接只是 Linux 的默认行为，我们还可以选择向客户端发送 RST 复位报文，告诉客户端连接已经建立失败。打开这一功能需要将 tcp_abort_on_overflow 参数设置为 1。

![img](https://mc.wsh-study.com/mkdocs/如何优化TCP/16.jpg)
...
![tcp_abort_on_overflow 为 0 可以应对突发流量](https://mc.wsh-study.com/mkdocs/如何优化TCP/17.jpg)
...
![img](https://mc.wsh-study.com/mkdocs/如何优化TCP/18.jpg)
...
![img](https://mc.wsh-study.com/mkdocs/如何优化TCP/19.jpg)
...
![常规 HTTP 请求](https://mc.wsh-study.com/mkdocs/如何优化TCP/20.jpg)

在 Linux 3.7 内核版本之后，提供了 TCP Fast Open 功能，这个功能可以减少 TCP 连接建立的时延。

> 接下来说说，TCP Fast Open 功能的工作方式。

![开启 TCP Fast Open 功能](https://mc.wsh-study.com/mkdocs/如何优化TCP/21.jpg)
...
![TCP option 字段 - TFO](https://mc.wsh-study.com/mkdocs/如何优化TCP/22.png)
...
![img](https://mc.wsh-study.com/mkdocs/如何优化TCP/23.jpg)
...
![三次握手优化策略](https://mc.wsh-study.com/mkdocs/如何优化TCP/24.jpg)
...
![客户端主动关闭](https://mc.wsh-study.com/mkdocs/如何优化TCP/25.jpg)
...
![img](https://mc.wsh-study.com/mkdocs/如何优化TCP/26.jpg)
...
![img](https://mc.wsh-study.com/mkdocs/如何优化TCP/27.jpg)

你可能会好奇，这 0 表示几次？ **实际上当为 0 时，特指 8 次** ，从下面的内核源码可知：

![img](https://mc.wsh-study.com/mkdocs/如何优化TCP/28.jpg)
...
![img](https://mc.wsh-study.com/mkdocs/如何优化TCP/29.jpg)
...
![img](https://mc.wsh-study.com/mkdocs/如何优化TCP/30.jpg)
...
![TIME-WAIT 时间过短，收到旧连接的数据报文](https://mc.wsh-study.com/mkdocs/如何优化TCP/31.png)
...
![TIME-WAIT 时间过短，没有确保连接正常关闭](https://mc.wsh-study.com/mkdocs/如何优化TCP/32.png)

服务端收到这个 RST 并将其解释为一个错误（Connection reset by peer），这对于一个可靠的协议来说不是一个优雅的终止方式。

为了防止这种情况出现，客户端必须等待足够长的时间，确保服务端能够收到 ACK，如果服务端没有收到 ACK，那么就会触发 TCP 重传机制，服务端会重新发送一个 FIN，这样一去一来刚好两个 MSL 的时间。

![TIME-WAIT 时间正常，确保了连接正常关闭](https://mc.wsh-study.com/mkdocs/如何优化TCP/33.png)
...
![img](https://mc.wsh-study.com/mkdocs/如何优化TCP/34.jpg)
...
![img](https://mc.wsh-study.com/mkdocs/如何优化TCP/35.jpg)
...
![img](https://mc.wsh-study.com/mkdocs/如何优化TCP/36.jpg)
...
![TCP option 字段 - 时间戳](https://mc.wsh-study.com/mkdocs/如何优化TCP/37.png)
...
![img](https://mc.wsh-study.com/mkdocs/如何优化TCP/38.jpg)

> TIME_WAIT 状态优化方式三

我们可以在程序中设置 socket 选项，来设置调用 close 关闭连接行为。

![img](https://mc.wsh-study.com/mkdocs/如何优化TCP/39.jpg)
...
![同时关闭](https://mc.wsh-study.com/mkdocs/如何优化TCP/40.jpg)
...
![四次挥手的优化策略](https://mc.wsh-study.com/mkdocs/如何优化TCP/41.jpg)
...
![按数据包进行确认应答](https://mc.wsh-study.com/mkdocs/如何优化TCP/42.jpg)

所以，这样的传输方式有一个缺点：数据包的 **往返时间越长，通信的效率就越低** 。

 **要解决这一问题不难，并行批量发送报文，再批量确认报文即可。**  

![并行处理](https://mc.wsh-study.com/mkdocs/如何优化TCP/43.jpg)
...
![TCP 头部](https://mc.wsh-study.com/mkdocs/如何优化TCP/44.jpg)
...
![TCP option 选项 - 窗口扩展](https://mc.wsh-study.com/mkdocs/如何优化TCP/45.png)

Linux 中打开这一功能，需要把 tcp_window_scaling 配置设为 1（默认打开）：

![img](https://mc.wsh-study.com/mkdocs/如何优化TCP/46.jpg)
...
![img](https://mc.wsh-study.com/mkdocs/如何优化TCP/47.jpg)
...
![img](https://mc.wsh-study.com/mkdocs/如何优化TCP/48.jpg)
...
![img](https://mc.wsh-study.com/mkdocs/如何优化TCP/49.jpg)
...
![img](https://mc.wsh-study.com/mkdocs/如何优化TCP/50.jpg)

> 调节 TCP 内存范围

接收缓冲区调节时，怎么知道当前内存是否紧张或充分呢？这是通过 tcp_mem 配置完成的：

![img](https://mc.wsh-study.com/mkdocs/如何优化TCP/51.jpg)
...
![数据传输的优化策略](https://mc.wsh-study.com/mkdocs/如何优化TCP/52.jpg)
