...
![img](https://mc.wsh-study.com/mkdocs/TCP协议有什么缺陷/1.png)

TCP 三次握手的延迟被 TCP Fast Open （快速打开）这个特性解决了，这个特性可以在「第二次建立连接」时减少 TCP 连接建立的时延。

![常规 HTTP 请求 与 Fast  Open HTTP 请求](https://mc.wsh-study.com/mkdocs/TCP协议有什么缺陷/2.jpg)
...
![img](https://mc.wsh-study.com/mkdocs/TCP协议有什么缺陷/3.png)
...
![img](https://mc.wsh-study.com/mkdocs/TCP协议有什么缺陷/4.png)
...
![img](https://mc.wsh-study.com/mkdocs/TCP协议有什么缺陷/5.jpg)

## 网络迁移需要重新建立 TCP 连接

基于 TCP 传输协议的 HTTP 协议，由于是通过四元组（源 IP、源端口、目的 IP、目的端口）确定一条 TCP 连接。

![TCP 四元组](https://mc.wsh-study.com/mkdocs/TCP协议有什么缺陷/6.png)
...
![img](https://mc.wsh-study.com/mkdocs/TCP协议有什么缺陷/7.png)
