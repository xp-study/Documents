...
![img](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/1.png)
...
![TCP 头格式](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/2.png)
...
![OSI 参考模型与 TCP/IP 的关系](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/3.png)
...
![img](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/4.png)
...
![img](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/5.png)
...
![TCP 四元组](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/6.png)
...
![img](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/7.png)
...
![UDP 头部格式](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/8.png)
...
![img](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/9.png)
...
![img](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/10.png)
...
![TCP 三次握手](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/11.png)

- 一开始，客户端和服务端都处于 `CLOSE` 状态。先是服务端主动监听某个端口，处于 `LISTEN` 状态

![第一个报文—— SYN 报文](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/12.png)

- 客户端会随机初始化序号（`client_isn`），将此序号置于 TCP 首部的「序号」字段中，同时把 `SYN` 标志位置为 `1` ，表示 `SYN` 报文。接着把第一个 SYN 报文发送给服务端，表示向服务端发起连接，该报文不包含应用层数据，之后客户端处于 `SYN-SENT` 状态。

![第二个报文 —— SYN + ACK 报文](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/13.png)

- 服务端收到客户端的 `SYN` 报文后，首先服务端也随机初始化自己的序号（`server_isn`），将此序号填入 TCP 首部的「序号」字段中，其次把 TCP 首部的「确认应答号」字段填入 `client_isn + 1`, 接着把 `SYN` 和 `ACK` 标志位置为 `1`。最后把该报文发给客户端，该报文也不包含应用层数据，之后服务端处于 `SYN-RCVD` 状态。

![第三个报文 —— ACK 报文](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/14.png)
...
![TCP 连接状态查看](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/15.png)
...
![三次握手避免历史连接](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/16.png)
...
![两次握手无法阻止历史连接](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/17.png)
...
![img](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/18.png)
...
![四次握手与三次握手](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/19.png)
...
![两次握手会造成资源浪费](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/20.png)
...
![img](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/21.png)
...
![img](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/22.png)
...
![MTU 与 MSS](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/23.png)
...
![握手阶段协商 MSS](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/24.png)
...
![img](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/25.png)
...
![img](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/26.png)
...
![img](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/27.png)
...
![SYN 攻击](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/28.png)
...
![正常流程](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/29.png)
...
![tcp_syncookies 应对 SYN 攻击](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/30.png)
...
![客户端主动关闭连接 —— TCP 四次挥手](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/31.png)
...
![img](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/32.png)
...
![img](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/33.png)
...
![img](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/34.png)

但是注意，如果主动关闭方使用 shutdown 函数关闭连接，指定了只关闭发送方向，而接收方向并没有关闭，那么意味着主动关闭方还是可以接收数据的。

此时，如果主动关闭方一直没收到第三次挥手，那么主动关闭方的连接将会一直处于 `FIN_WAIT2` 状态（`tcp_fin_timeout` 无法控制 shutdown 关闭的连接）。如下图：

![img](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/35.png)
...
![img](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/36.png)
...
![img](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/37.png)
...
![TCP 抓包图](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/38.png)

通过前面我们知道， **序列号和初始化序列号并不是无限递增的，会发生回绕为初始值的情况，这意味着无法根据序列号来判断新老数据** 。

假设 TIME-WAIT 没有等待时间或时间过短，被延迟的数据包抵达后会发生什么呢？

![TIME-WAIT 时间过短，收到旧连接的数据报文](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/39.png)
...
![TIME-WAIT 时间过短，没有确保连接正常关闭](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/40.png)

服务端收到这个 RST 并将其解释为一个错误（Connection reset by peer），这对于一个可靠的协议来说不是一个优雅的终止方式。

为了防止这种情况出现，客户端必须等待足够长的时间，确保服务端能够收到 ACK，如果服务端没有收到 ACK，那么就会触发 TCP 重传机制，服务端会重新发送一个 FIN，这样一去一来刚好两个 MSL 的时间。

![TIME-WAIT 时间正常，确保了连接正常关闭](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/41.png)
...
![HTTP 短连接](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/42.png)
...
![img](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/43.png)
...
![HTTP 长连接超时](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/44.png)
...
![img](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/45.png)
...
![web 服务的 心跳机制](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/46.png)
...
![基于 TCP 协议的客户端和服务端工作](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/47.png)
...
![ SYN 队列 与 Accpet 队列 ](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/48.png)
...
![socket 三次握手](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/49.png)
...
![客户端调用 close 过程](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/50.png)
...
![半连接队列与全连接队列](https://mc.wsh-study.com/mkdocs/TCP三次握手与四次挥手面试题/51.jpg)
