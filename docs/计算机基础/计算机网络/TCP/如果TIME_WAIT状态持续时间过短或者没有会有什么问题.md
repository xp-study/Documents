...
![图片](https://mc.wsh-study.com/mkdocs/如果TIME_WAIT状态持续时间过短或者没有会有什么问题/1.png)

![图片](https://mc.wsh-study.com/mkdocs/如果TIME_WAIT状态持续时间过短或者没有会有什么问题/2.png)
...
![图片](https://mc.wsh-study.com/mkdocs/如果TIME_WAIT状态持续时间过短或者没有会有什么问题/3.png)

### 什么是 TIME_WAIT 状态？

TCP 四次挥手过程，如下图：

![图片](https://mc.wsh-study.com/mkdocs/如果TIME_WAIT状态持续时间过短或者没有会有什么问题/4.png)图片
...
![图片](https://mc.wsh-study.com/mkdocs/如果TIME_WAIT状态持续时间过短或者没有会有什么问题/5.png)
...
![图片](https://mc.wsh-study.com/mkdocs/如果TIME_WAIT状态持续时间过短或者没有会有什么问题/6.png)
