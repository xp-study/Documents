...
![图片](https://mc.wsh-study.com/mkdocs/在TIME_WAIT状态的TCP连接收到SYN后会发生什么/1.png)
...
![图片](https://mc.wsh-study.com/mkdocs/在TIME_WAIT状态的TCP连接收到SYN后会发生什么/2.png)
...
![图片](https://mc.wsh-study.com/mkdocs/在TIME_WAIT状态的TCP连接收到SYN后会发生什么/3.png)
...
![img](https://mc.wsh-study.com/mkdocs/在TIME_WAIT状态的TCP连接收到SYN后会发生什么/4.png)
