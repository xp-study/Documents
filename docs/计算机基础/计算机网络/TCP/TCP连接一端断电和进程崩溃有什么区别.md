...
![在这里插入图片描述](https://mc.wsh-study.com/mkdocs/TCP连接一端断电和进程崩溃有什么区别/1.png)

这个属于  **TCP 异常断开连接** 的场景，这部分内容在我的「图解网络」还没有详细介绍过，这次就乘着这次机会补一补。

![在这里插入图片描述](https://mc.wsh-study.com/mkdocs/TCP连接一端断电和进程崩溃有什么区别/2.png)
...
![在这里插入图片描述](https://mc.wsh-study.com/mkdocs/TCP连接一端断电和进程崩溃有什么区别/3.png)
...
![在这里插入图片描述](https://mc.wsh-study.com/mkdocs/TCP连接一端断电和进程崩溃有什么区别/4.png)
...
![在这里插入图片描述](https://mc.wsh-study.com/mkdocs/TCP连接一端断电和进程崩溃有什么区别/5.png)
...
![img](https://mc.wsh-study.com/mkdocs/TCP连接一端断电和进程崩溃有什么区别/6.png)

> 那 TCP 的数据报文具体重传几次呢？

在 Linux 系统中，提供一个叫 tcp_retries2 配置项，默认值是 15，如下图：

![在这里插入图片描述](https://mc.wsh-study.com/mkdocs/TCP连接一端断电和进程崩溃有什么区别/7.png)
...
![在这里插入图片描述](https://mc.wsh-study.com/mkdocs/TCP连接一端断电和进程崩溃有什么区别/8.png)
