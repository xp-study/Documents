...
![图片](https://mc.wsh-study.com/mkdocs/服务端没有listen客户端发起连接建立会发生什么/1.png)
...
![图片](https://mc.wsh-study.com/mkdocs/服务端没有listen客户端发起连接建立会发生什么/2.png)

报错连接服务器失败。

同时，我也用抓包工具，抓了这个过程。

![图片](https://mc.wsh-study.com/mkdocs/服务端没有listen客户端发起连接建立会发生什么/3.png)
...
![图片](https://mc.wsh-study.com/mkdocs/服务端没有listen客户端发起连接建立会发生什么/4.png)
...
![图片](https://mc.wsh-study.com/mkdocs/服务端没有listen客户端发起连接建立会发生什么/5.png)
...
![图片](https://mc.wsh-study.com/mkdocs/服务端没有listen客户端发起连接建立会发生什么/6.png)
...
![img](https://mc.wsh-study.com/mkdocs/服务端没有listen客户端发起连接建立会发生什么/7.png)

通过 netstat 命令命令客户端自连接的 TCP 连接：

![在这里插入图片描述](https://mc.wsh-study.com/mkdocs/服务端没有listen客户端发起连接建立会发生什么/8.png)
