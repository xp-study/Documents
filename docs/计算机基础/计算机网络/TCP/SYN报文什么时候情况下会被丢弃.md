...
![img](https://mc.wsh-study.com/mkdocs/SYN报文什么时候情况下会被丢弃/1.png)
...
![img](https://mc.wsh-study.com/mkdocs/SYN报文什么时候情况下会被丢弃/2.png)
...
![img](https://mc.wsh-study.com/mkdocs/SYN报文什么时候情况下会被丢弃/3.png)
...
![img](https://mc.wsh-study.com/mkdocs/SYN报文什么时候情况下会被丢弃/4.png)
...
![img](https://mc.wsh-study.com/mkdocs/SYN报文什么时候情况下会被丢弃/5.png)
...
![img](https://mc.wsh-study.com/mkdocs/SYN报文什么时候情况下会被丢弃/6.png)
...
![img](https://mc.wsh-study.com/mkdocs/SYN报文什么时候情况下会被丢弃/7.png)

增大 backlog 的方式，每个 Web 服务都不同，比如 Nginx 增大 backlog 的方法如下：

![img](https://mc.wsh-study.com/mkdocs/SYN报文什么时候情况下会被丢弃/8.png)
...
![img](https://mc.wsh-study.com/mkdocs/SYN报文什么时候情况下会被丢弃/9.png)
...
![img](https://mc.wsh-study.com/mkdocs/SYN报文什么时候情况下会被丢弃/10.png)

### 全连接队列满了

 **在服务端并发处理大量请求时，如果 TCP accpet 队列过小，或者应用程序调用 accept() 不及时，就会造成 accpet 队列满了 ，这时后续的连接就会被丢弃，这样就会出现服务端请求数量上不去的现象。**  

![img](https://mc.wsh-study.com/mkdocs/SYN报文什么时候情况下会被丢弃/11.png)

我们可以通过 ss 命令来看 accpet 队列大小，在「LISTEN 状态」时，`Recv-Q/Send-Q` 表示的含义如下：

![img](https://mc.wsh-study.com/mkdocs/SYN报文什么时候情况下会被丢弃/12.png)
