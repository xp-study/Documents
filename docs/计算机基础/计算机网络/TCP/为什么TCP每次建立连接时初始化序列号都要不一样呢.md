...
![img](https://mc.wsh-study.com/mkdocs/为什么TCP每次建立连接时初始化序列号都要不一样呢/1.png)
...
![img](https://mc.wsh-study.com/mkdocs/为什么TCP每次建立连接时初始化序列号都要不一样呢/2.png)
...
![img](https://mc.wsh-study.com/mkdocs/为什么TCP每次建立连接时初始化序列号都要不一样呢/3.png)
...
![图片](https://mc.wsh-study.com/mkdocs/为什么TCP每次建立连接时初始化序列号都要不一样呢/4.png)
