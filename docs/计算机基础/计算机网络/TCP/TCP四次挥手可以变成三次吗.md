...
![img](https://mc.wsh-study.com/mkdocs/TCP四次挥手可以变成三次吗/1.png)

虽然我们在学习 TCP 挥手时，学到的是需要四次来完成 TCP 挥手，但是 **在一些情况下， TCP 四次挥手是可以变成 TCP 三次挥手的** 。

![在这里插入图片描述](https://mc.wsh-study.com/mkdocs/TCP四次挥手可以变成三次吗/2.png)

而且在用 wireshark 工具抓包的时候，我们也会常看到 TCP 挥手过程是三次，而不是四次，如下图：

![在这里插入图片描述](https://mc.wsh-study.com/mkdocs/TCP四次挥手可以变成三次吗/3.png)
...
![在这里插入图片描述](https://mc.wsh-study.com/mkdocs/TCP四次挥手可以变成三次吗/4.png)
...
![在这里插入图片描述](https://mc.wsh-study.com/mkdocs/TCP四次挥手可以变成三次吗/5.png)
...
![优雅关闭.drawio.png](https://mc.wsh-study.com/mkdocs/TCP四次挥手可以变成三次吗/6.png)
...
![在这里插入图片描述](https://mc.wsh-study.com/mkdocs/TCP四次挥手可以变成三次吗/7.png)
...
![img](https://mc.wsh-study.com/mkdocs/TCP四次挥手可以变成三次吗/8.png)

延迟等待的时间是在 Linux 内核中定义的，如下图：

![img](https://mc.wsh-study.com/mkdocs/TCP四次挥手可以变成三次吗/9.png)

关键就需要 HZ 这个数值大小，HZ 是跟系统的时钟频率有关，每个操作系统都不一样，在我的 Linux 系统中 HZ 大小是 1000，如下图：

![img](https://mc.wsh-study.com/mkdocs/TCP四次挥手可以变成三次吗/10.png)
...
![在这里插入图片描述](https://mc.wsh-study.com/mkdocs/TCP四次挥手可以变成三次吗/11.png)

先启用服务端：

![在这里插入图片描述](https://mc.wsh-study.com/mkdocs/TCP四次挥手可以变成三次吗/12.png)
...
![在这里插入图片描述](https://mc.wsh-study.com/mkdocs/TCP四次挥手可以变成三次吗/13.png)

此时，服务端的输出：

![在这里插入图片描述](https://mc.wsh-study.com/mkdocs/TCP四次挥手可以变成三次吗/14.png)

接下来，我们来看看抓包的结果。

![在这里插入图片描述](https://mc.wsh-study.com/mkdocs/TCP四次挥手可以变成三次吗/15.png)
...
![在这里插入图片描述](https://mc.wsh-study.com/mkdocs/TCP四次挥手可以变成三次吗/16.png)

编译好服务端代码后，就开始运行服务端和客户端的代码，同时用 tcpdump 进行抓包。

抓包的结果如下，可以看到是四次挥手。 ![在这里插入图片描述](https://mc.wsh-study.com/mkdocs/TCP四次挥手可以变成三次吗/17.png)
