...
![img](https://mc.wsh-study.com/mkdocs/MySQL可重复读隔离级别完全解决幻读了吗/1.png)

然后在可重复读隔离级别下，有两个事务的执行顺序如下：

![在这里插入图片描述](https://mc.wsh-study.com/mkdocs/MySQL可重复读隔离级别完全解决幻读了吗/2.png)
...
![img](https://mc.wsh-study.com/mkdocs/MySQL可重复读隔离级别完全解决幻读了吗/3.png)
...
![img](https://mc.wsh-study.com/mkdocs/MySQL可重复读隔离级别完全解决幻读了吗/4.png)

举个具体例子，场景如下：

![img](https://mc.wsh-study.com/mkdocs/MySQL可重复读隔离级别完全解决幻读了吗/5.png)
...
![img](https://mc.wsh-study.com/mkdocs/MySQL可重复读隔离级别完全解决幻读了吗/6.png)
...
![img](https://mc.wsh-study.com/mkdocs/MySQL可重复读隔离级别完全解决幻读了吗/7.png)
