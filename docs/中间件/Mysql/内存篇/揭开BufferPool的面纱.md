...
![img](https://mc.wsh-study.com/mkdocs/揭开BufferPool的面纱/1.png)
...
![img](https://mc.wsh-study.com/mkdocs/揭开BufferPool的面纱/2.png)
...
![img](https://mc.wsh-study.com/mkdocs/揭开BufferPool的面纱/3.png)

为了更好的管理这些在 Buffer Pool 中的缓存页，InnoDB 为每一个缓存页都创建了一个 **控制块** ，控制块信息包括「缓存页的表空间、页号、缓存页地址、链表节点」等等。

控制块也是占有内存空间的，它是放在 Buffer Pool 的最前面，接着才是缓存页，如下图：

![img](https://mc.wsh-study.com/mkdocs/揭开BufferPool的面纱/4.png)
...
![img](https://mc.wsh-study.com/mkdocs/揭开BufferPool的面纱/5.png)
...
![img](https://mc.wsh-study.com/mkdocs/揭开BufferPool的面纱/6.png)
...
![img](https://mc.wsh-study.com/mkdocs/揭开BufferPool的面纱/7.png)

如果访问了 3 号的页，因为 3 号页在 Buffer Pool 里，所以把 3 号页移动到头部即可。

![img](https://mc.wsh-study.com/mkdocs/揭开BufferPool的面纱/8.png)

而如果接下来，访问了 8 号页，因为 8 号页不在 Buffer Pool 里，所以需要先淘汰末尾的 5 号页，然后再将 8 号页加入到头部。

![img](https://mc.wsh-study.com/mkdocs/揭开BufferPool的面纱/9.png)

到这里我们可以知道，Buffer Pool 里有三种页和链表来管理数据。

![img](https://mc.wsh-study.com/mkdocs/揭开BufferPool的面纱/10.png)
...
![img](https://mc.wsh-study.com/mkdocs/揭开BufferPool的面纱/11.png)
...
![img](https://mc.wsh-study.com/mkdocs/揭开BufferPool的面纱/12.png)

现在有个编号为 20 的页被预读了，这个页只会被插入到 old 区域头部，而 old 区域末尾的页（10号）会被淘汰掉。

![img](https://mc.wsh-study.com/mkdocs/揭开BufferPool的面纱/13.png)

如果 20 号页一直不会被访问，它也没有占用到 young 区域的位置，而且还会比 young 区域的数据更早被淘汰出去。

如果 20 号页被预读后，立刻被访问了，那么就会将它插入到 young 区域的头部，young 区域末尾的页（7号），会被挤到 old 区域，作为 old 区域的头部，这个过程并不会有页被淘汰。

![img](https://mc.wsh-study.com/mkdocs/揭开BufferPool的面纱/14.png)
...
![img](https://mc.wsh-study.com/mkdocs/揭开BufferPool的面纱/15.png)

在批量访问这些数据的时候，会被逐一插入到 young 区域头部。

![img](https://mc.wsh-study.com/mkdocs/揭开BufferPool的面纱/16.png)
