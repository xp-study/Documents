...
![图片](https://mc.wsh-study.com/mkdocs/从数据页的角度看B+树/1.png)
...
![图片](https://mc.wsh-study.com/mkdocs/从数据页的角度看B+树/2.png)

这 7 个部分的作用如下图：

![图片](https://mc.wsh-study.com/mkdocs/从数据页的角度看B+树/3.png)

在 File Header 中有两个指针，分别指向上一个数据页和下一个数据页，连接起来的页相当于一个双向的链表，如下图所示：

![图片](https://mc.wsh-study.com/mkdocs/从数据页的角度看B+树/4.png)
...
![图片](https://mc.wsh-study.com/mkdocs/从数据页的角度看B+树/5.png)
...
![图片](https://mc.wsh-study.com/mkdocs/从数据页的角度看B+树/6.png)
...
![图片](https://mc.wsh-study.com/mkdocs/从数据页的角度看B+树/7.png)
