...
![图片](https://mc.wsh-study.com/mkdocs/MySQL死锁了怎么办/1.png)

假设这时有两事务，一个事务要插入订单 1007 ，另外一个事务要插入订单 1008，因为需要对订单做幂等性校验，所以两个事务先要查询该订单是否存在，不存在才插入记录，过程如下：

![img](https://mc.wsh-study.com/mkdocs/MySQL死锁了怎么办/2.png)
...
![img](https://mc.wsh-study.com/mkdocs/MySQL死锁了怎么办/3.png)
...
![图片](https://mc.wsh-study.com/mkdocs/MySQL死锁了怎么办/4.png)
...
![img](https://mc.wsh-study.com/mkdocs/MySQL死锁了怎么办/5.png)
...
![img](https://mc.wsh-study.com/mkdocs/MySQL死锁了怎么办/6.png)
...
![img](https://mc.wsh-study.com/mkdocs/MySQL死锁了怎么办/7.png)
...
![img](https://mc.wsh-study.com/mkdocs/MySQL死锁了怎么办/8.png)
...
![img](https://mc.wsh-study.com/mkdocs/MySQL死锁了怎么办/9.png)
...
![img](https://mc.wsh-study.com/mkdocs/MySQL死锁了怎么办/10.png)
...
![img](https://mc.wsh-study.com/mkdocs/MySQL死锁了怎么办/13.png)
...
![img](https://mc.wsh-study.com/mkdocs/MySQL死锁了怎么办/14.png)
...
![img](https://mc.wsh-study.com/mkdocs/MySQL死锁了怎么办/17.png)

在隔离级别可重复读的情况下，开启两个事务，前后执行相同的 Insert 语句，此时 **事务 B 的 Insert 语句会发生阻塞** 。

![img](https://mc.wsh-study.com/mkdocs/MySQL死锁了怎么办/18.png)
...
![img](https://mc.wsh-study.com/mkdocs/MySQL死锁了怎么办/19.png)
...
![img](https://mc.wsh-study.com/mkdocs/MySQL死锁了怎么办/20.png)
...
![img](https://mc.wsh-study.com/mkdocs/MySQL死锁了怎么办/21.png)
...
![图片](https://mc.wsh-study.com/mkdocs/MySQL死锁了怎么办/22.png)

-  **开启主动死锁检测** 。主动死锁检测在发现死锁后，主动回滚死锁链条中的某一个事务，让其他事务得以继续执行。将参数 `innodb_deadlock_detect` 设置为 on，表示开启这个逻辑，默认就开启。

  当检测到死锁后，就会出现下面这个提示：

![图片](https://mc.wsh-study.com/mkdocs/MySQL死锁了怎么办/23.png)
