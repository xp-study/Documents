...
![在这里插入图片描述](https://mc.wsh-study.com/mkdocs/update没加索引会锁全表吗/1.png)
...
![img](https://mc.wsh-study.com/mkdocs/update没加索引会锁全表吗/2.png)

假设有两个事务的执行顺序如下：

![在这里插入图片描述](https://mc.wsh-study.com/mkdocs/update没加索引会锁全表吗/3.png)
...
![img](https://mc.wsh-study.com/mkdocs/update没加索引会锁全表吗/4.png)
...
![img](https://mc.wsh-study.com/mkdocs/update没加索引会锁全表吗/5.png)
