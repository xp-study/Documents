...
![查询语句执行流程](https://mc.wsh-study.com/mkdocs/执行一条select语句期间发生了什么/1.png)
...
![img](https://mc.wsh-study.com/mkdocs/执行一条select语句期间发生了什么/2.png)

如果 MySQL 服务正常运行，完成 TCP 连接的建立后，连接器就要开始验证你的用户名和密码，如果用户名或密码不对，就收到一个"Access denied for user"的错误，然后客户端程序结束执行。

![img](https://mc.wsh-study.com/mkdocs/执行一条select语句期间发生了什么/3.png)
...
![img](https://mc.wsh-study.com/mkdocs/执行一条select语句期间发生了什么/4.png)
...
![img](https://mc.wsh-study.com/mkdocs/执行一条select语句期间发生了什么/5.png)
...
![img](https://mc.wsh-study.com/mkdocs/执行一条select语句期间发生了什么/6.png)
...
![img](https://mc.wsh-study.com/mkdocs/执行一条select语句期间发生了什么/7.png)

如果查询语句的执行计划里的 key 为 null 说明没有使用索引，那就会全表扫描（type = ALL），这种查询扫描的方式是效率最低档次的，如下图：

![img](https://mc.wsh-study.com/mkdocs/执行一条select语句期间发生了什么/8.png)

这张 product 表只有一个索引就是主键，现在我在表中将 name 设置为普通索引（二级索引）。

![img](https://mc.wsh-study.com/mkdocs/执行一条select语句期间发生了什么/9.png)
...
![img](https://mc.wsh-study.com/mkdocs/执行一条select语句期间发生了什么/10.png)
...
![img](https://mc.wsh-study.com/mkdocs/执行一条select语句期间发生了什么/11.png)
...
![img](https://mc.wsh-study.com/mkdocs/执行一条select语句期间发生了什么/12.png)
...
![查询语句执行流程](https://mc.wsh-study.com/mkdocs/执行一条select语句期间发生了什么/13.png)
