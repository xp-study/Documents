...
![img](https://mc.wsh-study.com/mkdocs/Mysql一行记录是怎么存储的/1.png)
...
![img](https://mc.wsh-study.com/mkdocs/Mysql一行记录是怎么存储的/2.png)
...
![img](https://mc.wsh-study.com/mkdocs/Mysql一行记录是怎么存储的/3.png)
...
![img](https://mc.wsh-study.com/mkdocs/Mysql一行记录是怎么存储的/4.png)
...
![img](https://mc.wsh-study.com/mkdocs/Mysql一行记录是怎么存储的/5.png)
...
![img](https://mc.wsh-study.com/mkdocs/Mysql一行记录是怎么存储的/6.png)

同样的道理，我们也可以得出 **第二条记录** 的行格式中，「变长字段长度列表」里的内容是「 04 02」，如下图：

![img](https://mc.wsh-study.com/mkdocs/Mysql一行记录是怎么存储的/7.png)

 **第三条记录** 中 phone 列的值是 NULL， **NULL 是不会存放在行格式中记录的真实数据部分里的** ，所以「变长字段长度列表」里不需要保存值为 NULL 的变长字段的长度。

![img](https://mc.wsh-study.com/mkdocs/Mysql一行记录是怎么存储的/8.png)
...
![img](https://mc.wsh-study.com/mkdocs/Mysql一行记录是怎么存储的/15.png)
...
![img](https://mc.wsh-study.com/mkdocs/Mysql一行记录是怎么存储的/16.png)
...
![img](https://mc.wsh-study.com/mkdocs/Mysql一行记录是怎么存储的/17.png)

可以看到，还是不行，接下来看看 varchar(65532) 是否可行？

![img](https://mc.wsh-study.com/mkdocs/Mysql一行记录是怎么存储的/18.png)
...
![img](https://mc.wsh-study.com/mkdocs/Mysql一行记录是怎么存储的/19.png)
...
![img](https://mc.wsh-study.com/mkdocs/Mysql一行记录是怎么存储的/20.png)
...
![img](https://mc.wsh-study.com/mkdocs/Mysql一行记录是怎么存储的/21.png)
