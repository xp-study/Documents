...
![查询语句执行流程](https://mc.wsh-study.com/mkdocs/undolog与redolog与binlog有什么用/1.png)
...
![img](https://mc.wsh-study.com/mkdocs/undolog与redolog与binlog有什么用/2.png)
...
![回滚事务](https://mc.wsh-study.com/mkdocs/undolog与redolog与binlog有什么用/3.png)
...
![版本链](https://mc.wsh-study.com/mkdocs/undolog与redolog与binlog有什么用/4.png)
...
![Buffer Poo](https://mc.wsh-study.com/mkdocs/undolog与redolog与binlog有什么用/5.png)
...
![img](https://mc.wsh-study.com/mkdocs/undolog与redolog与binlog有什么用/6.png)
...
![img](https://mc.wsh-study.com/mkdocs/undolog与redolog与binlog有什么用/7.png)
...
![事务恢复](https://mc.wsh-study.com/mkdocs/undolog与redolog与binlog有什么用/8.png)
...
![事务恢复](https://mc.wsh-study.com/mkdocs/undolog与redolog与binlog有什么用/9.png)
...
![img](https://mc.wsh-study.com/mkdocs/undolog与redolog与binlog有什么用/10.png)
...
![img](https://mc.wsh-study.com/mkdocs/undolog与redolog与binlog有什么用/11.png)
...
![重做日志文件组](https://mc.wsh-study.com/mkdocs/undolog与redolog与binlog有什么用/12.png)
...
![重做日志文件组写入过程](https://mc.wsh-study.com/mkdocs/undolog与redolog与binlog有什么用/13.png)
...
![img](https://mc.wsh-study.com/mkdocs/undolog与redolog与binlog有什么用/14.png)
...
![MySQL 主从复制过程](https://mc.wsh-study.com/mkdocs/undolog与redolog与binlog有什么用/15.png)
...
![MySQL 主从架构](https://mc.wsh-study.com/mkdocs/undolog与redolog与binlog有什么用/16.png)
...
![binlog cach](https://mc.wsh-study.com/mkdocs/undolog与redolog与binlog有什么用/17.png)
...
-  **准备阶段** ：裁判（协调者）会依次询问两位拳击手（参与者）是否准备好了，然后拳击手听到后做出应答，如果觉得自己准备好了，就会跟裁判说准备好了；如果没有准备好（比如拳套还没有带好），就会跟裁判说还没准备好。
...
![两阶段提交](https://mc.wsh-study.com/mkdocs/undolog与redolog与binlog有什么用/18.png)
...
![时刻 A 与时刻 B](https://mc.wsh-study.com/mkdocs/undolog与redolog与binlog有什么用/19.png)
...
![每个阶段都有一个队列](https://mc.wsh-study.com/mkdocs/undolog与redolog与binlog有什么用/20.png)
...
![img](https://mc.wsh-study.com/mkdocs/undolog与redolog与binlog有什么用/21.png)

接着，获取队列中的事务组，由绿色事务组的 Leader 对 rodo log 做一次 write + fsync，即一次将同组事务的 redolog 刷盘：

![img](https://mc.wsh-study.com/mkdocs/undolog与redolog与binlog有什么用/22.png)

完成了 prepare 阶段后，将绿色这一组事务执行过程中产生的 binlog 写入 binlog 文件（调用 write，不会调用 fsync，所以不会刷盘，binlog 缓存在操作系统的文件系统中）。

![img](https://mc.wsh-study.com/mkdocs/undolog与redolog与binlog有什么用/23.png)
...
![img](https://mc.wsh-study.com/mkdocs/undolog与redolog与binlog有什么用/24.png)

不过，在等待的过程中，如果事务的数量提前达到了 `Binlog_group_commit_sync_no_delay_count` 参数设置的值，就不用继续等待了，就马上将 binlog 刷盘，如下图：

![img](https://mc.wsh-study.com/mkdocs/undolog与redolog与binlog有什么用/25.png)
...
![img](https://mc.wsh-study.com/mkdocs/undolog与redolog与binlog有什么用/26.png)
