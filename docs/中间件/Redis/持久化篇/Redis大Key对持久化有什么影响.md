...
![·](https://mc.wsh-study.com/mkdocs/Redis大Key对持久化有什么影响/1.png)
...
![img](https://mc.wsh-study.com/mkdocs/Redis大Key对持久化有什么影响/2.png)
...
![img](https://mc.wsh-study.com/mkdocs/Redis大Key对持久化有什么影响/3.png) 这样一来，子进程就共享了父进程的物理内存数据了，这样能够节约物理内存资源，页表对应的页表项的属性会标记该物理内存的权限为 **只读** 。
...
![img](https://mc.wsh-study.com/mkdocs/Redis大Key对持久化有什么影响/4.png)
