...
![图片](https://mc.wsh-study.com/mkdocs/RDB快照是怎么实现的/1.png)

只有在发生修改内存数据的情况时，物理内存才会被复制一份。

![图片](https://mc.wsh-study.com/mkdocs/RDB快照是怎么实现的/2.png)
...
![图片](https://mc.wsh-study.com/mkdocs/RDB快照是怎么实现的/3.png)
