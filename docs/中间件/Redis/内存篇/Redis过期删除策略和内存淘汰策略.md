...
![img](https://mc.wsh-study.com/mkdocs/Redis过期删除策略和内存淘汰策略/1.jpg)
...
![img](https://mc.wsh-study.com/mkdocs/Redis过期删除策略和内存淘汰策略/2.png)
...
![img](https://mc.wsh-study.com/mkdocs/Redis过期删除策略和内存淘汰策略/3.jpg)
...
![img](https://mc.wsh-study.com/mkdocs/Redis过期删除策略和内存淘汰策略/4.jpg)
...
![img](https://mc.wsh-study.com/mkdocs/Redis过期删除策略和内存淘汰策略/5.jpg)
...
![img](https://mc.wsh-study.com/mkdocs/Redis过期删除策略和内存淘汰策略/6.png)
...
![img](https://mc.wsh-study.com/mkdocs/Redis过期删除策略和内存淘汰策略/7.jpg)

内存淘汰策略是解决内存过大的问题，当 Redis 的运行内存超过最大运行内存时，就会触发内存淘汰策略，Redis 4.0 之后共实现了 8 种内存淘汰策略，我也对这 8 种的策略进行分类，如下：

![img](https://mc.wsh-study.com/mkdocs/Redis过期删除策略和内存淘汰策略/8.jpg)
