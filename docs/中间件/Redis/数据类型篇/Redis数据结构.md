...
![img](https://mc.wsh-study.com/mkdocs/Redis数据结构/1.png)
...
![img](https://mc.wsh-study.com/mkdocs/Redis数据结构/2.png)
...
![img](https://mc.wsh-study.com/mkdocs/Redis数据结构/3.png)
...
![img](https://mc.wsh-study.com/mkdocs/Redis数据结构/4.png)
...
![img](https://mc.wsh-study.com/mkdocs/Redis数据结构/5.png)
...
![img](https://mc.wsh-study.com/mkdocs/Redis数据结构/6.png)
...
![img](https://mc.wsh-study.com/mkdocs/Redis数据结构/7.png)



![img](https://mc.wsh-study.com/mkdocs/Redis数据结构/8.png)
...
![img](https://mc.wsh-study.com/mkdocs/Redis数据结构/9.png)
...
![img](https://mc.wsh-study.com/mkdocs/Redis数据结构/10.png)
...
![img](https://mc.wsh-study.com/mkdocs/Redis数据结构/11.png)
...
![img](https://mc.wsh-study.com/mkdocs/Redis数据结构/12.png)
...
![img](https://mc.wsh-study.com/mkdocs/Redis数据结构/13.png)
...
![img](https://mc.wsh-study.com/mkdocs/Redis数据结构/14.png)
...
![img](https://mc.wsh-study.com/mkdocs/Redis数据结构/15.png)
...
![img](https://mc.wsh-study.com/mkdocs/Redis数据结构/16.png)
...
![img](https://mc.wsh-study.com/mkdocs/Redis数据结构/17.png)

因为这些节点长度值小于 254 字节，所以 prevlen 属性需要用 1 字节的空间来保存这个长度值。

这时，如果将一个长度大于等于 254 字节的新节点加入到压缩列表的表头节点，即新节点将成为 e1 的前置节点，如下图：

![img](https://mc.wsh-study.com/mkdocs/Redis数据结构/18.png)

因为 e1 节点的 prevlen 属性只有 1 个字节大小，无法保存新节点的长度，此时就需要对压缩列表的空间重分配操作，并将 e1 节点的 prevlen 属性从原来的 1 字节大小扩展为 5 字节大小。

多米诺牌的效应就此开始。

![img](https://mc.wsh-study.com/mkdocs/Redis数据结构/19.png)
...
![img](https://mc.wsh-study.com/mkdocs/Redis数据结构/20.png)
...
![img](https://mc.wsh-study.com/mkdocs/Redis数据结构/21.png)
...
![img](https://mc.wsh-study.com/mkdocs/Redis数据结构/22.png)
...
![img](https://mc.wsh-study.com/mkdocs/Redis数据结构/23.png)
...
![img](https://mc.wsh-study.com/mkdocs/Redis数据结构/24.png)
...
![img](https://mc.wsh-study.com/mkdocs/Redis数据结构/25.png)
...
![img](https://mc.wsh-study.com/mkdocs/Redis数据结构/26.png)


![img](https://mc.wsh-study.com/mkdocs/Redis数据结构/27.png)

扩容完 contents 数组空间大小后，需要将之前的三个元素转换为 int32_t 类型，并将转换后的元素放置到正确的位上面，并且需要维持底层数组的有序性不变，整个转换过程如下：

![img](https://mc.wsh-study.com/mkdocs/Redis数据结构/28.png)
...
![img](https://mc.wsh-study.com/mkdocs/Redis数据结构/29.png)
...
![img](https://mc.wsh-study.com/mkdocs/Redis数据结构/30.png)
...
![img](https://mc.wsh-study.com/mkdocs/Redis数据结构/31.png)
...
![img](https://mc.wsh-study.com/mkdocs/Redis数据结构/32.png)
...
![img](https://mc.wsh-study.com/mkdocs/Redis数据结构/33.png)
...
![img](https://mc.wsh-study.com/mkdocs/Redis数据结构/34.png)
...
![img](https://mc.wsh-study.com/mkdocs/Redis数据结构/35.png)

listpack 头包含两个属性，分别记录了 listpack 总字节数和元素数量，然后 listpack 末尾也有个结尾标识。图中的 listpack entry 就是 listpack 的节点了。

每个 listpack 节点结构如下：

![img](https://mc.wsh-study.com/mkdocs/Redis数据结构/36.png)
