...
![img](https://mc.wsh-study.com/mkdocs/一致性Hash算法/1.png)
...
![img](https://mc.wsh-study.com/mkdocs/一致性Hash算法/2.png)
...
![img](https://mc.wsh-study.com/mkdocs/一致性Hash算法/3.png)
...
![img](https://mc.wsh-study.com/mkdocs/一致性Hash算法/4.png)
...
![img](https://mc.wsh-study.com/mkdocs/一致性Hash算法/5.png)

当 3 个节点不能满足业务需求了，这时我们增加了一个节点，节点的数量从 3 变化为 4，意味取模哈希函数中基数的变化，这样会导致 **大部分映射关系改变** ，如下图：

![img](https://mc.wsh-study.com/mkdocs/一致性Hash算法/6.png)
...
![img](https://mc.wsh-study.com/mkdocs/一致性Hash算法/7.png)
...
![img](https://mc.wsh-study.com/mkdocs/一致性Hash算法/8.png)
...
![img](https://mc.wsh-study.com/mkdocs/一致性Hash算法/9.png)
...
![img](https://mc.wsh-study.com/mkdocs/一致性Hash算法/10.png)

你可以看到，key-01、key-03 都不受影响，只有 key-02 需要被迁移节点 D。

假设节点数量从 3 减少到了 2，比如将节点 A 移除：

![img](https://mc.wsh-study.com/mkdocs/一致性Hash算法/11.png)
...
![img](https://mc.wsh-study.com/mkdocs/一致性Hash算法/12.png)
...
![img](https://mc.wsh-study.com/mkdocs/一致性Hash算法/13.png)
