...
![img](https://mc.wsh-study.com/mkdocs/BM算法/1.jpg)

单个字符滑动

![img](https://mc.wsh-study.com/mkdocs/BM算法/2.jpg)
...
![img](https://mc.wsh-study.com/mkdocs/BM算法/3.jpg)

从前向后匹配

![img](https://mc.wsh-study.com/mkdocs/BM算法/4.jpg)
...
![img](https://mc.wsh-study.com/mkdocs/BM算法/5.jpg)

##### 1.1模式串中不含坏字符

如果模式串中不包含坏字符，也就是 c，那就说明这个字符不可能匹配。这个时候，我们可以直接将模式串滑动到 c 后面的位置，开启新的匹配。

![img](https://mc.wsh-study.com/mkdocs/BM算法/6.jpg)

##### 1.2模式串中包含坏字符

如果模式串中包含坏字符，我们可以直接将模式串向后移动到与坏字符对齐的位置，开启新的匹配。

![img](https://mc.wsh-study.com/mkdocs/BM算法/7.jpg)
...
![img](https://mc.wsh-study.com/mkdocs/BM算法/8.jpg)
...
![img](https://mc.wsh-study.com/mkdocs/BM算法/9.jpg)
...
![img](https://mc.wsh-study.com/mkdocs/BM算法/10.jpg)

##### 2.2模式串中只包含一个好后缀

如果模式串只有一个为 {u} 的子串，我们就可以直接将模式串滑动到主串中 {u} 的后面：

![img](https://mc.wsh-study.com/mkdocs/BM算法/11.jpg)

##### 2.3模式串中的后缀子串和前缀子串重合

注意，在 2.2 的滑动在某些情况下是正确的，但是在某些情况下会 **过度滑动** ：

![img](https://mc.wsh-study.com/mkdocs/BM算法/12.jpg)
...
![img](https://mc.wsh-study.com/mkdocs/BM算法/13.jpg)

所以，针对这种情况，我们不仅需要看模式串是否有多个好后缀（2.1），还要看好后缀的后缀子串是否和模式串的前缀子串存在匹配，你可以通过下面的图加深理解：

![img](https://mc.wsh-study.com/mkdocs/BM算法/14.jpg)
...
![img](https://mc.wsh-study.com/mkdocs/BM算法/15.jpg)
...
![img](https://mc.wsh-study.com/mkdocs/BM算法/16.jpg)
...
![img](https://mc.wsh-study.com/mkdocs/BM算法/17.jpg)
...
![img](https://mc.wsh-study.com/mkdocs/BM算法/18.jpg)
...
![img](https://mc.wsh-study.com/mkdocs/BM算法/19.jpg)
...
![img](https://mc.wsh-study.com/mkdocs/BM算法/20.jpg)
...
- 有重复子串的情况：
  ...
  ![img](https://mc.wsh-study.com/mkdocs/BM算法/21.jpg)

- 后缀子串和前缀子串重合的情况：

  好后缀的后缀子串 b[ r , m - 1]，的长度为 k = m - r，如果prefix[k] == true ，表示长度为 k 的后缀子串 有 可以匹配的前缀子串，这样我们可以把模式串后移 r 位。

  ![img](https://mc.wsh-study.com/mkdocs/BM算法/22.jpg)

- 前两条规则的子串都不存在：我们直接向模式串后移 m 位：

  ![img](https://mc.wsh-study.com/mkdocs/BM算法/23.jpg)
