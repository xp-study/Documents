...
![img](https://mc.wsh-study.com/mkdocs/GMP原理与调度/1.png)
...
![img](https://mc.wsh-study.com/mkdocs/GMP原理与调度/2.png)
...
![img](https://mc.wsh-study.com/mkdocs/GMP原理与调度/3.png)
...
![img](https://mc.wsh-study.com/mkdocs/GMP原理与调度/4.png)



 这样，我们再去细化去分类一下，内核线程依然叫“线程(thread)”，用户线程叫“协程(co-routine)".

![img](https://mc.wsh-study.com/mkdocs/GMP原理与调度/5.png)
...
![img](https://mc.wsh-study.com/mkdocs/GMP原理与调度/6.png)
...
![img](https://mc.wsh-study.com/mkdocs/GMP原理与调度/7.png)

> #### M:N关系

M个协程绑定1个线程，是N:1和1:1类型的结合，克服了以上2种模型的缺点，但实现起来最为复杂。

![img](https://mc.wsh-study.com/mkdocs/GMP原理与调度/8.png)
...
![img](https://mc.wsh-study.com/mkdocs/GMP原理与调度/9.png)

 下面我们来看看被废弃的golang调度器是如何实现的？

![img](https://mc.wsh-study.com/mkdocs/GMP原理与调度/10.png)
...
![img](https://mc.wsh-study.com/mkdocs/GMP原理与调度/11.png)
...
![img](https://mc.wsh-study.com/mkdocs/GMP原理与调度/12.png)
...
![img](https://mc.wsh-study.com/mkdocs/GMP原理与调度/13.png)
...
![img](https://mc.wsh-study.com/mkdocs/GMP原理与调度/14.png)
...
![img](https://mc.wsh-study.com/mkdocs/GMP原理与调度/15.png)

![img](https://mc.wsh-study.com/mkdocs/GMP原理与调度/16.png)

**G信息**

点击Goroutines那一行可视化的数据条，我们会看到一些详细的信息。

![img](https://mc.wsh-study.com/mkdocs/GMP原理与调度/17.png)
...
![img](https://mc.wsh-study.com/mkdocs/GMP原理与调度/18.png)

 一共有两个M在程序中，一个是特殊的M0，用于初始化使用，这个我们不必讨论。

**P信息**

![img](https://mc.wsh-study.com/mkdocs/GMP原理与调度/19.png)
...
![img](https://mc.wsh-study.com/mkdocs/GMP原理与调度/20.png)

我们会发现，确实G18在P0上被运行的时候，确实在Threads行多了一个M的数据，点击查看如下：
![img](https://mc.wsh-study.com/mkdocs/GMP原理与调度/21.png)
...
![img](https://mc.wsh-study.com/mkdocs/GMP原理与调度/22.png)
...
![img](https://mc.wsh-study.com/mkdocs/GMP原理与调度/23.png)
...
![img](https://mc.wsh-study.com/mkdocs/GMP原理与调度/24.png)
...
> ![img](https://mc.wsh-study.com/mkdocs/GMP原理与调度/25.png)
...
![img](https://mc.wsh-study.com/mkdocs/GMP原理与调度/26.png)
...
![img](https://mc.wsh-study.com/mkdocs/GMP原理与调度/27.png)
...
![img](https://mc.wsh-study.com/mkdocs/GMP原理与调度/28.png)
...
![img](https://mc.wsh-study.com/mkdocs/GMP原理与调度/29.png)
...
![img](https://mc.wsh-study.com/mkdocs/GMP原理与调度/30.png)
...
![img](https://mc.wsh-study.com/mkdocs/GMP原理与调度/31.png)
...
![img](https://mc.wsh-study.com/mkdocs/GMP原理与调度/32.png)
