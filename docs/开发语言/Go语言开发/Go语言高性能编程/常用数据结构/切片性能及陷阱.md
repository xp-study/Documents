...
![golang slice](https://mc.wsh-study.com/mkdocs/切片性能及陷阱/1.jpg)
...
![hpg-slice](https://mc.wsh-study.com/mkdocs/切片性能及陷阱/2.jpg)

### 2.2 Append

![hpg-slice](https://mc.wsh-study.com/mkdocs/切片性能及陷阱/3.jpg)
...
![hpg-slice](https://mc.wsh-study.com/mkdocs/切片性能及陷阱/4.jpg)

切片的底层是数组，因此删除意味着后面的元素需要逐个向前移位。每次删除的复杂度为 O(N)，因此切片不合适大量随机删除的场景，这种场景下适合使用链表。

### 2.4 Delete(GC)

![hpg-slice](https://mc.wsh-study.com/mkdocs/切片性能及陷阱/5.jpg)

删除后，将空余的位置置空，有助于垃圾回收。

### 2.5 Insert

![hpg-slice](https://mc.wsh-study.com/mkdocs/切片性能及陷阱/6.jpg)

insert 和 append 类似。即在某个位置添加一个元素后，将该位置后面的元素再 append 回去。复杂度为 O(N)。因此，不适合大量随机插入的场景。

### 2.6 Filter

![hpg-slice](https://mc.wsh-study.com/mkdocs/切片性能及陷阱/7.jpg)

当原切片不会再被使用时，就地 filter 方式是比较推荐的，可以节省内存空间。

### 2.7 Push

![hpg-slice](https://mc.wsh-study.com/mkdocs/切片性能及陷阱/8.jpg)

在末尾追加元素，不考虑内存拷贝的情况，复杂度为 O(1)。

![hpg-slice](https://mc.wsh-study.com/mkdocs/切片性能及陷阱/9.jpg)

在头部追加元素，时间和空间复杂度均为 O(N)，不推荐。

### 2.8 Pop

![hpg-slice](https://mc.wsh-study.com/mkdocs/切片性能及陷阱/10.jpg)

尾部删除元素，复杂度 O(1)

![hpg-slice](https://mc.wsh-study.com/mkdocs/切片性能及陷阱/11.jpg)
