...
![image-20221125222249552](https://mc.wsh-study.com/mkdocs/使用NSIS制作安装包/1.png)

选择“使用脚本向导创建新的脚本文件”，确定

![image-20221125222326268](https://mc.wsh-study.com/mkdocs/使用NSIS制作安装包/2.png)

进步脚本向导，下一步

![image-20221125222447122](https://mc.wsh-study.com/mkdocs/使用NSIS制作安装包/3.png)

第一步，这里填写应用程序的一些基本信息，下一步

![image-20221125222629091](https://mc.wsh-study.com/mkdocs/使用NSIS制作安装包/4.png)

第二步，这里是选择安装包的图标，生成的文件名，程序语言等，使用默认的就可以，不需要修改

![image-20221125222657899](https://mc.wsh-study.com/mkdocs/使用NSIS制作安装包/5.png)

第三步，选择一些效果，安装程序不用搞这么花哨，直接下一步

![image-20221125222812976](https://mc.wsh-study.com/mkdocs/使用NSIS制作安装包/6.png)

第四步，指定默认目录，授权文件有的话就指定，没有就空着，下一步

![image-20221125222840472]![image-20221125222812977](https://mc.wsh-study.com/mkdocs/使用NSIS制作安装包/7.png)

第五步，选择要打包的文件，直接把要打包的目录内容全部添加进来，注意两处*.*，以及勾选“包含子目录”，不要勾选”单独添加每个文件“，编译的时候会把所有的文件打包进来的，下一步

![image-20221125222922218](https://mc.wsh-study.com/mkdocs/使用NSIS制作安装包/8.png)

第六步，快捷方式的一些设置，下一步

![image-20221125222959952](https://mc.wsh-study.com/mkdocs/使用NSIS制作安装包/9.png)

第七步，设置安装程序之后要运行的内容，下一步

![image-20221125223029076](https://mc.wsh-study.com/mkdocs/使用NSIS制作安装包/10.png)

第八步，卸载信息设置，下一步

![image-20221125223100739](https://mc.wsh-study.com/mkdocs/使用NSIS制作安装包/11.png)

完成向导，勾选”保存脚本“，以及”转换文件路径到相对路径“，完成

![image-20221125223126379](https://mc.wsh-study.com/mkdocs/使用NSIS制作安装包/12.png)

这时就可以看到通过向导生成的脚本，可以在这里继续修改脚本

![image-20221125223155977](https://mc.wsh-study.com/mkdocs/使用NSIS制作安装包/13.png)

修改完脚本以后，点击菜单”NSIS“-》"编译并运行"，编译成功后，会生成一个exe文件，安装包制作完成！

![image-20221125223225719](https://mc.wsh-study.com/mkdocs/使用NSIS制作安装包/14.png)
